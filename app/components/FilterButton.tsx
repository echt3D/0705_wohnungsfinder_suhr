const FilterButton = ({ t }: { t: string }) => {
  return (
    <section
      //   onClick={() => setOpenFilter(!openFilter)}
      className={`md:w-1/4 xl:w-full shadow-xl border bg-secondary rounded-lg flex justify-between items-center cursor-pointer p-4 text-text_primary
      }`}
    >
